...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.transition0 = self._make_transition_layer([64], num_channels)
        ...
        final_inp_channels = np.int(np.sum(pre_stage_channels))
    ...
    def forward(self, x):
        ...
        x4 = F.upsample(x[4], size=(x0_h, x0_w), mode='bilinear')

        x = torch.cat([x[0], x1, x2, x3, x4], 1)
